...
if(isset($_GET['loc']))
{
	...
	error_reporting(1);
	include("config.php");
		$query = "insert into search(bankuser,locationid) values('".$_SESSION['bankuser']."','".$loc."')";
...
<body>
   ...
   <div class="news_section layout_padding">
      <div class="container">
         <h1 class="news_taital">IFSC Code</h1>
               ...
               <div class="col-md-12">
				  ...
				  <?php
						if(isset($_GET['loc']))
							{
								$loc=$_GET['loc'];
								include 'config.php';
								$sql1 = "select bank.bankname,branch.city,branch.branch FROM bank INNER JOIN branch ON bank.id=branch.bankname where branch.id='".$loc."'";
								...
								?>
                     <h4 class="make_text">IFSC Code Finder : <b style="text-transform: uppercase;color:blue;"><?php echo $bank; ?> </b>&nbsp;&nbsp;(<?php echo $city; ?>,<?php echo $branch; ?>)</h4>
                     <table class="table table-hover">
						...
						if(isset($_GET['loc']))
							{
								$loc=$_GET['loc'];
								include 'config.php';
								$sql1 = "select bank.bankname,branch.ifsc,branch.city,branch.micr,branch.cdate ,branch.branch FROM bank INNER JOIN branch ON bank.id=branch.bankname where branch.id='".$loc."'";
								$result1 = mysqli_query($con,$sql1);
								$num1=mysqlI_num_rows($result1);
								$sl=0;
								if($num1 > 0)
                          ...
                          <tr>
                            <td><?php echo $sl; ?></td>
                            <td><b><?php echo $ifsc; ?></b></td>
                            <td><b><?php echo $micr; ?></b></td>
                          </tr>
                          <?php
								}
								}
					  ...
					  <a href="index.php" class="btn btn-primary mb-2">Done</a>
                  </div>
               </div>
