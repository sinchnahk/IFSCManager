...
<body>
   ...
   <div class="news_section layout_padding">
      <div class="container">
         <h1 class="news_taital">Search DEtails</h1>
						...
						if(isset($_GET['sea']))
							{
								$sea=$_GET['sea'];
								include 'config.php';
								$sql1 = "select bank.bankname FROM bank INNER JOIN branch ON bank.id=branch.bankname where branch.bankname='".$sea."'";
								...
								?>
                     <h4 class="make_text">IFSC Code Finder : <b style="text-transform: uppercase;color:blue;"><?php echo $bankname; ?></b> </h4>
						...
						if(isset($_GET['sea']))
							{
								$sea=$_GET['sea'];
								include 'config.php';
								$sql1 = "select * from branch where bankname='".$sea."'";
								$result1 = mysqli_query($con,$sql1);
								$num1=mysqlI_num_rows($result1);
								$sl=0;
								if($num1 > 0)
                          ...
                          <tr>
                            ...
                            <td><?php echo $city; ?></td>
                            <td>
								<a href="locationsearch.php?loc=<?php echo $id; ?>" class="btn btn-primary mb-2">Search</a>
							</td>
                          </tr>
                          <?php
								}
